...
- [자기소개 부탁드립니다.](#자기소개)
- [자신의 강점과 약점은 무엇인가요?](#)
- [가장 최근에 해결한 기술적인 문제는 무엇이었나요? / 최근 기억에 남는 에러에 대해 소개해주세요](#기술이슈에러)
- [프론트엔드 개발자를 선택한 이유](#프론트엔드-개발자를-선택한-이유)
- [비전공자로서 개발자 직업을 선택한 이유](#개발자로-진로를-정한-이유)
- [개발자로서 5년 후 / 10년 후의 목표](#개발자로서-5년-후의-목표)
- 회사를 선택하는 기준이 있다면 무엇인지 알려달라
- [인생에서 어려운 문제를 해결한 경험이 있다면 알려달라]()
- 본래 전공을 선택한 이유는?
- 시간이 2주정도 주어진다면 어떤 것을 더 공부할 예정인가 / frontend 역량 향상을 위해 어떤 것을 학습할 생각인가?
- 회사 지원 동기가 어떻게 되시나요.
- [요즘 공부중이시는 것에 대해 설명해주세요.](#최근-공부하고-있는-것)
- [새로운 기술을 습득하기 위해 어떠한 방식으로 연구하시나요?](#새로운-기술을-학습하기-위한-방법)
- [협업을 하면서 갈등이 생겼던 경험이 있으신가요?](#협업에서-갈등이-생겼던-경험)
- 본인이 자주 사용하는 웹 어플리케이션이 있다면 어떤게 있는지 설명해주세요. 그리고 왜 그 어플리케이션을 사용하시나요?
- [본인이 사용하면서 결국 사용하지 않게 된 웹 어플리케이션 있다면 어떤게 있는지 설명해주세요. 그리고 왜 그 어플리케이션을 사용하시지 않게 되셨나요?](#사용하지-않게-된-어플리케이션)
- 만나고 싶지 않은 사수

## 브라우저
- [브라우저 렌더링 과정에 대해서 설명해보세요.](./Browser/readme.md/#브라우저-렌더링)
- [브라우저 저장소에 대해 아는대로 설명해주세요](./Browser/readme.md/#브라우저-저장소)
- [브라우저 주소창에 google을 입력하면 발생하는 일을 설명해주세요.](./Browser/readme.md/#브라우저-주소창에-googlecom을-입력하면-일어나는-일)
- [DNS에 대해 설명해주세요.](./Browser/readme.md/#dns에-대해-설명해주세요)
- [페이지 로드 시간을 줄이는 방법들에 대해서 설명해주세요.](./Browser/readme.md/#브라우저-렌더링-최적화)
- [리플로우와 리페인트](./Browser/readme.md/#리플로우reflow와-리페인트repaint)

## HTML&CSS
- [CSS Postion에 대해 설명해보세요. => relative / fix / absolute](#css-postion에-대해-설명해보세요--relative--fix--absolute)
- [Flex와 Grid의 차이점에 대해서 설명해보세요.](#flex와-grid의-차이)
- [반응형 웹의 구현](#반응형-웹)
- form 요소의 동작방식 + react-form 사용경험에 대해 설명해주세요
- CSS 박스모델 margin/padding이 차지하는 크기는 어떻게 되나요?
- HTML에서의 attributes와 properties의 차이점을 설명해주세요.
- [Sementic Markup에 대해 설명해주세요.](#시맨틱-마크업)
- SASS, SCSS를 사용해보신 경험이 있다면 설명해주세요.

## JS
- [호이스팅](#호이스팅)
- [스코프와 클로저란 무엇인가요?](#스코프와-클로저)
- [콜백함수와 콜백지옥을 해결하는 방법](#콜백지옥)
- [async/await에 대해 설명해보세요.](#asyncawait)
- ["==" 와 "==="의 차이는 무엇인가요?]()
- 이벤트루프 & 비동기
- 싱글스레드와 멀티스레드
...
- require와 import의 차이
- 화살표 함수를 사용하는 이유
- map과 foreach의 차이에 대해 설명
- 이벤트 버블링과 이벤트 캡쳐에 대해 설명해주세요
- 이벤트 위임 패턴에 대해 설명해주세요
- DOM에 대해 설명해주세요.
- Promise에 대해 설명해주세요
...
- 타입스크립트의 장단점
- 타입스크립트에서의 배열작동 원리
- any타입과 unknown 타입을 비교해서 설명해주세요
- 유니온 타입은 언제 사용하나요?
- 타입스크립트에서는 어떻게 객체를 생성하게 되나요?
...
- useMemo/useCallback vs useState/useEffect
...
- TCP/IP 4계층에 대해 아는대로 설명해보세요.
- 그렇다면 HTTP 메소드에 대한 설명도 해주실 수 있나요?
- HTTP와 HTTPS의 차이
- CORS에러를 해결하는 방법
- [HTTP1.1 vs HTTP 2 vs HTTP 3](./Network/readme.md)
- [HTTP 구조](./Network/readme.md/#http-구조)
...
## 프로젝트
- 프로젝트에서 어떤 것을 담당하셨나요?
- [팀원들간의 갈등은 어떻게 해결하셨나요?](#협업에서-갈등이-생겼던-경험)
- [백엔드와 소통은 어떻게 진행하셨나요?](#)
- 프로젝트 안에서 자신의 의견이 관철되었던 경험을 이야기해주세요.
- 프로젝트의 아키텍쳐에 대해 설명해주세요
- 전역상태관리 라이브러리로 Redux나 RTK를 사용하시지 않고, Recoil를 사용하신 이유는 무엇인가요? 실제로 구현 단계에서 스스로 코드를 작성하셨나요?
- 프로젝트에서 CloudFront를 사용하신 이유에 대해 설명해주세요.
...
## 테스팅
- 테스팅을 해보신 경험이 있나요? 있다면 어떤 계기로 테스팅을 도입하시게 되었나요?
- TDD란 무엇인가요?
- 유닛테스트와 통합테스트
- Jest의 선언 & describe & it
...
- 모놀리스 서비스와 마이크로 서비스의 차이

## 리팩토링
- 짧지 않은 시간동안 리팩토링을 하면서 어떤 것을 학습하셨나요?
- 리팩토링을 하면서 가장 신경썼던 부분은 무엇인가요?
- Vite와 Vitest를 사용하신 이유에 대해 설명해주세요
- React-query를 도입하시면서 얻으신 이점에 대해 설명해주세요

## git 협업
- git을 활용해서 협업을 진행해본 경험에 대해 설명해주세요

## Chat GPT
- Chat GPT를 사용해보신 경험이 있는가요? 있다면 어떤 경우에 주로 사용하셨나요?
